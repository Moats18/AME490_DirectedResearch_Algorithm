%
% This script is designed as a test for the functions within the MATLAB
% minimizationAlgorithm function which is based on the paper:
% 
...
xNew = x_minimization(x, yNew, Fj, Tj, J, R, U, h);
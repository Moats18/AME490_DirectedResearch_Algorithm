...
mu = 0.5;
theta = pi/4; % must be sheared relative to theta_0
lambda = mu_0 * cos(theta_0) / (mu * cos(theta)); % enforce rigidity

l1D = [lambda; 0; 0];
l2D = mu*[cos(theta)  -sin(theta)   0; sin(theta) cos(theta)    0;  0   0   1]*l1D;
